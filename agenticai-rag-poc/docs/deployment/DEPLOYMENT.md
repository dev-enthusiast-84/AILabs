...
| [Vercel Deployment](deployment/DEPLOY-VERCEL.md) | Full-stack serverless deploy, one-command setup, known Vercel limitations |
| [Vercel Advanced](deployment/DEPLOY-VERCEL-ADVANCED.md) | CI/non-interactive deploy, multi-environment management, teardown |
